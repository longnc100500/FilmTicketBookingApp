...
export default class UpcomingList extends React.Component {
  ...
  constructor(props) {
    ...
    this.diffClampScrollY=Animated.diffClamp(this.scrollYAnimatedValue,0,HEADER_MAX_HEIGHT);
  ...
  componentDidMount() {
    ...
    fetch(
      'https://api.themoviedb.org/3/movie/upcoming?api_key=b5d5cdc41bceae3132ead55454bde93c&language=en-US&page=2'
    )
               ...
               <View style={styles.row}>
                 ...
                 /></View>
                   ...
                   <TouchableOpacity style={styles.bookButton}
                     onPress={()=>this.props.navigation.navigate('upComingDetails',{movieID:itemData.item.id})}
                   >
                     <Image style={{width:50,height:50,tintColor:'#4A148C'}}
                     source={require('../Image/detail.png')}
                     />
                   </TouchableOpacity>
                   </View>
                 </View>
